...
async fn download_wasi_sdk() -> Result<PathBuf> {
    ...
    const MAJOR_VERSION_ENV_VAR: &str = "ZINT_WASM_SYS_WASI_SDK_MAJOR_VERSION";
    const MINOR_VERSION_ENV_VAR: &str = "ZINT_WASM_SYS_WASI_SDK_MINOR_VERSION";
...
async fn get_wasi_sdk_path() -> Result<PathBuf> {
    const WASI_SDK_PATH_ENV_VAR: &str = "ZINT_WASM_SYS_WASI_SDK_PATH";
